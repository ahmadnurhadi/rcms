...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url();?>" class="logo">
      ...
      <span class="logo-mini"><b>RCMS</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>RCMS AGS 216</b></span>
    </a>
	...
	<h1 style="float: left; margin: 6px;"><b><?php echo "[".$systemAreaCode." ".$systemIdentificationCode."]&nbsp;&nbsp;&nbsp;".$stationName; ?></b></h1>
